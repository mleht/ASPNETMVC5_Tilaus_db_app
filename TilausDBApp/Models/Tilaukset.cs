...
namespace TilausDBApp.Models
{
    ...
    public partial class Tilaukset
    {
        ...
        [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:yyyy/MM/dd}")] public Nullable<System.DateTime> Tilauspvm { get; set; }
        [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:yyyy/MM/dd}")] public Nullable<System.DateTime> Toimituspvm { get; set; }
        // otin neuvoa: https://www.koskila.net/help-my-asp-net-mvc-textbox-date-format-is-wrong/
